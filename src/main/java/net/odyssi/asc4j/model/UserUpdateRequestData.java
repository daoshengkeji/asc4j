 ...
 */
@JsonPropertyOrder({ UserUpdateRequestData.JSON_PROPERTY_TYPE, UserUpdateRequestData.JSON_PROPERTY_ID,
		UserUpdateRequestData.JSON_PROPERTY_ATTRIBUTES, UserUpdateRequestData.JSON_PROPERTY_RELATIONSHIPS })

public class UserUpdateRequestData implements Serializable {
	/**
	 *
	 */
	private static final long serialVersionUID = -9066460135695320410L;
