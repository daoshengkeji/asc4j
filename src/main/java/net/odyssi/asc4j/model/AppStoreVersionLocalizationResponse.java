 ...
 */
@JsonPropertyOrder({ AppStoreVersionLocalizationResponse.JSON_PROPERTY_DATA,
		AppStoreVersionLocalizationResponse.JSON_PROPERTY_INCLUDED,
		AppStoreVersionLocalizationResponse.JSON_PROPERTY_LINKS })

public class AppStoreVersionLocalizationResponse implements Serializable {
	/**
	 *
	 */
	private static final long serialVersionUID = 5306695236529029243L;
	...
	private List<AppStoreVersionLocalizationResponseIncludedOneOf> included = null;
	private DocumentLinks links;

	public AppStoreVersionLocalizationResponse addIncludedItem(
			AppStoreVersionLocalizationResponseIncludedOneOf includedItem) {
	...
	public List<AppStoreVersionLocalizationResponseIncludedOneOf> getIncluded() {
	...
	public AppStoreVersionLocalizationResponse included(
			List<AppStoreVersionLocalizationResponseIncludedOneOf> included) {
	...
	public void setIncluded(List<AppStoreVersionLocalizationResponseIncludedOneOf> included) {
		this.included = included;
	}
