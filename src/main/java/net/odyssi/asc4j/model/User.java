 ...
 * User
 */
@JsonPropertyOrder({ User.JSON_PROPERTY_TYPE, User.JSON_PROPERTY_ID, User.JSON_PROPERTY_ATTRIBUTES,
		User.JSON_PROPERTY_RELATIONSHIPS, User.JSON_PROPERTY_LINKS })

public class User implements Serializable {
	/**
	 *
	 */
	private static final long serialVersionUID = -4961638420589093395L;
	...
	public boolean equals(java.lang.Object o) {
		...
		User user = (User) o;
		return Objects.equals(this.type, user.type) && Objects.equals(this.id, user.id)
				&& Objects.equals(this.attributes, user.attributes)
				&& Objects.equals(this.relationships, user.relationships) && Objects.equals(this.links, user.links);
	}
