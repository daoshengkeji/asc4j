...
public class BundleIdBundleIdCapabilitiesLinkagesResponse extends BaseServiceResponse {
	...
	public boolean equals(Object obj) {
		...
		BundleIdBundleIdCapabilitiesLinkagesResponse other = (BundleIdBundleIdCapabilitiesLinkagesResponse) obj;
		if (this.data == null) {
			if (other.data != null) {
				return false;
			}
	...
	public String toString() {
		return "BundleIdBundleIdCapabilitiesLinkagesResponse [data=" + this.data + "]";
	}
}
