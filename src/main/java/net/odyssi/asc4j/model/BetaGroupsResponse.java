 ...
 * BetaGroupsResponse
 */
@JsonPropertyOrder({ BetaGroupsResponse.JSON_PROPERTY_DATA, BetaGroupsResponse.JSON_PROPERTY_INCLUDED,
		BetaGroupsResponse.JSON_PROPERTY_LINKS, BetaGroupsResponse.JSON_PROPERTY_META })

public class BetaGroupsResponse implements Serializable {
	/**
	 *
	 */
	private static final long serialVersionUID = -8127192014635762843L;
	...
	private List<BetaGroupsResponseIncludedOneOf> included = null;
	...
	public BetaGroupsResponse addIncludedItem(BetaGroupsResponseIncludedOneOf includedItem) {
	...
	public List<BetaGroupsResponseIncludedOneOf> getIncluded() {
	...
	public BetaGroupsResponse included(List<BetaGroupsResponseIncludedOneOf> included) {
	...
	public void setIncluded(List<BetaGroupsResponseIncludedOneOf> included) {
		this.included = included;
	}
