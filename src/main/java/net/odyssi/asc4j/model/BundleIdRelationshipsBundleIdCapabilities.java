...
public class BundleIdRelationshipsBundleIdCapabilities {
	...
	public boolean equals(Object obj) {
		...
		BundleIdRelationshipsBundleIdCapabilities other = (BundleIdRelationshipsBundleIdCapabilities) obj;
		if (this.data == null) {
			if (other.data != null) {
				return false;
			}
	...
	public String toString() {
		return "BundleIdRelationshipsBundleIdCapabilities [data=" + this.data + ", links=" + this.links + ", meta="
				+ this.meta + "]";
	}
