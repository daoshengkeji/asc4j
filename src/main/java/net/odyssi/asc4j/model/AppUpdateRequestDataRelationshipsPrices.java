...
public class AppUpdateRequestDataRelationshipsPrices implements Serializable {
	...
	public AppUpdateRequestDataRelationshipsPrices addDataItem(AppRelationshipsPricesData dataItem) {
		if (this.data == null) {
	...
	public AppUpdateRequestDataRelationshipsPrices data(List<AppRelationshipsPricesData> data) {
	...
	public boolean equals(java.lang.Object o) {
		...
		AppUpdateRequestDataRelationshipsPrices appUpdateRequestDataRelationshipsPrices = (AppUpdateRequestDataRelationshipsPrices) o;
		return Objects.equals(this.data, appUpdateRequestDataRelationshipsPrices.data);
	}
