...
public class ProfileRelationshipsCertificates {
	...
	public boolean equals(Object obj) {
		...
		ProfileRelationshipsCertificates other = (ProfileRelationshipsCertificates) obj;
		if (this.data == null) {
			if (other.data != null) {
				return false;
			}
	...
	public String toString() {
		return "ProfileRelationshipsCertificates [data=" + this.data + ", links=" + this.links + ", meta=" + this.meta
				+ "]";
	}
