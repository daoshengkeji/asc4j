 ...
 */
@JsonPropertyOrder({ UserInvitationCreateRequestData.JSON_PROPERTY_TYPE,
		UserInvitationCreateRequestData.JSON_PROPERTY_ATTRIBUTES,
		UserInvitationCreateRequestData.JSON_PROPERTY_RELATIONSHIPS })

public class UserInvitationCreateRequestData implements Serializable {
	/**
	 * Gets or Sets type
	 */
	 ...
	 *
	 */
	private static final long serialVersionUID = -4676658455588840514L;
