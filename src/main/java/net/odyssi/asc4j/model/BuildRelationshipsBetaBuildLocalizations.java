 ...
 */
@JsonPropertyOrder({ BuildRelationshipsBetaBuildLocalizations.JSON_PROPERTY_LINKS,
...
public class BuildRelationshipsBetaBuildLocalizations implements Serializable {
	...
	public BuildRelationshipsBetaBuildLocalizations addDataItem(BuildRelationshipsBetaBuildLocalizationsData dataItem) {
		if (this.data == null) {
	...
	public BuildRelationshipsBetaBuildLocalizations data(List<BuildRelationshipsBetaBuildLocalizationsData> data) {
	...
	public List<BuildRelationshipsBetaBuildLocalizationsData> getData() {
		return this.data;
	}
	...
	public BuildRelationshipsBetaBuildLocalizations links(AppCategoryRelationshipsSubcategoriesLinks links) {
	...
	public void setData(List<BuildRelationshipsBetaBuildLocalizationsData> data) {
		this.data = data;
	}
