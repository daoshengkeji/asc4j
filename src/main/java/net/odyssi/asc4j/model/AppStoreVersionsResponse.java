 ...
 */
@JsonPropertyOrder({ AppStoreVersionsResponse.JSON_PROPERTY_DATA, AppStoreVersionsResponse.JSON_PROPERTY_INCLUDED,
...
public class AppStoreVersionsResponse implements Serializable {
	...
	public AppStoreVersionsResponse addIncludedItem(AppStoreVersionsResponseIncludedOneOf includedItem) {
	...
	public List<AppStoreVersionsResponseIncludedOneOf> getIncluded() {
	...
	public AppStoreVersionsResponse included(List<AppStoreVersionsResponseIncludedOneOf> included) {
	...
	public void setIncluded(List<AppStoreVersionsResponseIncludedOneOf> included) {
		this.included = included;
	}
