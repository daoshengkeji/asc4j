 ...
 */
@JsonPropertyOrder({ GameCenterEnabledVersion.JSON_PROPERTY_TYPE, GameCenterEnabledVersion.JSON_PROPERTY_ID,
		GameCenterEnabledVersion.JSON_PROPERTY_ATTRIBUTES, GameCenterEnabledVersion.JSON_PROPERTY_RELATIONSHIPS,
		GameCenterEnabledVersion.JSON_PROPERTY_LINKS })

public class GameCenterEnabledVersion implements Serializable, AppResponseIncludedOneOf, AppsResponseIncludedOneOf {
	/**
	 * Gets or Sets type
	 */
	 ...
	 *
	 */
	private static final long serialVersionUID = 8640523980498793646L;
