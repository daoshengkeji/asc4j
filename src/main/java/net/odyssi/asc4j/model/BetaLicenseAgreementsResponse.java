 ...
 */
@JsonPropertyOrder({ BetaLicenseAgreementsResponse.JSON_PROPERTY_DATA,
		BetaLicenseAgreementsResponse.JSON_PROPERTY_INCLUDED, BetaLicenseAgreementsResponse.JSON_PROPERTY_LINKS,
		BetaLicenseAgreementsResponse.JSON_PROPERTY_META })

public class BetaLicenseAgreementsResponse implements Serializable {
	 ...
	 *
	 */
	private static final long serialVersionUID = -3558588934087125750L;

	private List<BetaLicenseAgreement> data = new ArrayList<>();
	...
	public BetaLicenseAgreementsResponse data(List<BetaLicenseAgreement> data) {
	...
	public BetaLicenseAgreementsResponse included(List<App> included) {
