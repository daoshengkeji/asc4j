...
public class BetaLicenseAgreementsResponse {
	 ...
	 */
	@JsonProperty("data")
	private List<BetaLicenseAgreement> data = new ArrayList<BetaLicenseAgreement>();
	 ...
	 */
	@JsonProperty("data")
	public List<BetaLicenseAgreement> getData() {
		return this.data;
	}
	 ...
	 */
	@JsonProperty("data")
	public void setData(List<BetaLicenseAgreement> data) {
		this.data = data;
	}
