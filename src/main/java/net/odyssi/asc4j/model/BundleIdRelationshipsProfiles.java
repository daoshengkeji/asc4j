...
public class BundleIdRelationshipsProfiles {
	...
	public boolean equals(Object obj) {
		...
		BundleIdRelationshipsProfiles other = (BundleIdRelationshipsProfiles) obj;
		if (this.data == null) {
			if (other.data != null) {
				return false;
			}
	...
	public String toString() {
		return "BundleIdRelationshipsProfiles [data=" + this.data + ", links=" + this.links + ", meta=" + this.meta
				+ "]";
	}
