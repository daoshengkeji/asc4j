...
public class EndUserLicenseAgreementCreateRequestDataRelationshipsTerritories implements Serializable {
	...
	public EndUserLicenseAgreementCreateRequestDataRelationshipsTerritories addDataItem(
			AppPricePointRelationshipsTerritoryData dataItem) {
		this.data.add(dataItem);
		return this;
	}

	public EndUserLicenseAgreementCreateRequestDataRelationshipsTerritories data(
