 ...
 */
@JsonPropertyOrder({ AppPreOrderCreateRequestDataRelationshipsApp.JSON_PROPERTY_DATA })
public class AppPreOrderCreateRequestDataRelationshipsApp implements Serializable {

	public static final String JSON_PROPERTY_DATA = "data";

	private static final long serialVersionUID = -6316328923218161954L;
