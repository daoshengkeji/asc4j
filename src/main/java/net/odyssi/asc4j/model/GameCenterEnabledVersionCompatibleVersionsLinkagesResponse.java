 ...
 */
@JsonPropertyOrder({ GameCenterEnabledVersionCompatibleVersionsLinkagesResponse.JSON_PROPERTY_DATA,
		GameCenterEnabledVersionCompatibleVersionsLinkagesResponse.JSON_PROPERTY_LINKS,
		GameCenterEnabledVersionCompatibleVersionsLinkagesResponse.JSON_PROPERTY_META })

public class GameCenterEnabledVersionCompatibleVersionsLinkagesResponse implements Serializable {
	 ...
	 *
	 */
	private static final long serialVersionUID = 4630982821026280557L;
	...
	public GameCenterEnabledVersionCompatibleVersionsLinkagesResponse addDataItem(
			AppRelationshipsGameCenterEnabledVersionsData dataItem) {
		this.data.add(dataItem);
		return this;
	}

	public GameCenterEnabledVersionCompatibleVersionsLinkagesResponse data(
