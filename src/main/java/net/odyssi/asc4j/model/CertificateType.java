...
public enum CertificateType {
	...
	DEVELOPMENT("DEVELOPMENT"), DISTRIBUTION("DISTRIBUTION"), IOS_DEVELOPMENT("IOS_DEVELOPMENT"),
	IOS_DISTRIBUTION("IOS_DISTRIBUTION"), MAC_APP_DEVELOPMENT("MAC_APP_DEVELOPMENT"),
	MAC_APP_DISTRIBUTION("MAC_APP_DISTRIBUTION"), MAC_INSTALLER_DISTRIBUTION("MAC_INSTALLER_DISTRIBUTION");
