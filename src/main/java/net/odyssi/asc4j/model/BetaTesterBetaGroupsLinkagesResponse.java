 ...
 */
@JsonPropertyOrder({ BetaTesterBetaGroupsLinkagesResponse.JSON_PROPERTY_DATA,
...
public class BetaTesterBetaGroupsLinkagesResponse implements Serializable {
	...
	public BetaTesterBetaGroupsLinkagesResponse addDataItem(AppRelationshipsBetaGroupsData dataItem) {
		this.data.add(dataItem);
		return this;
	}

	public BetaTesterBetaGroupsLinkagesResponse data(List<AppRelationshipsBetaGroupsData> data) {
